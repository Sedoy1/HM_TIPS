...
def pi(state, params):
    ...
    print(np.cumsum(alt_error),  np.cumsum(ang_error))
...
if __name__ == "__main__":
    ...
    params_pd = np.array([0.31257404, -3.76061896, 6.28134819, 0.29837368])
    ...
    if optimize_params:
        ...
        vid = VideoRecorder(env, path=f"random_luna_lander_pi_reg.mp4")
